...
from replan2eplus.ezobjects.epbunch_utils import (
    set_difference,
    sort_and_group_objects_dict,
)
from bidict import bidict

from replan2eplus.subsurfaces.interfaces import IndexPair, Details, Location
...
class EdgesList(BaseModel):
    ...
    internal - doors
    external - windows
    ids for the link details map to the id of the subsurface details.. 
    maybe some sort of graph would be more efficient.. 
    ...
    def airboundary_edges(self):
        return [i.as_replan_edge for i in self.airboundary_links]
